...
function get_sidebar($selected_menu = 'home')
{
    ...
    echo sidebar_menu_item('File a Complaint', SITE_HOME . 'file-a-complaint', $icons['file-a-complaint'], $selected_menu == 'file-a-complaint');
    echo sidebar_menu_item('All Complaints', SITE_HOME . 'all-complaints', $icons['all-complaints'], $selected_menu == 'all-complaints');
    ...
    echo sidebar_menu_item('Support', SITE_HOME . 'support', $icons['support'], $selected_menu == 'support');
    echo sidebar_menu_item('Logout', SITE_HOME . 'logout', $icons['logout'], $selected_menu == 'logout');
